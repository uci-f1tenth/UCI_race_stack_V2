...
class MultiAgentRaceEnv(gymnasium.Env):
    ...
    def __init__(
        ...
        assert render_mode in self.metadata["render_modes"], f"Invalid render mode: {
            render_mode
        }"
    ...
    @property
    def world(self):
        """Return the World object associated with this scenario."""
        return self._scenario.world

    @property
    def agents(self):
        return self._scenario.agents
